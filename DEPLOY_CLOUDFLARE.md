...
- `worker.js` contact API (`/api/contact`) that sends email via Resend
...
2. Set Worker secret once: `npx wrangler secret put RESEND_API_KEY`
3. Set vars in `wrangler.toml`: `CONTACT_TO_EMAIL`, `RESEND_FROM`, `CONTACT_FROM_NAME`
